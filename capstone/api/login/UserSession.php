...
require_once $root."/capstone/include/model/UserLoginModel.php";
require_once $root."/capstone/include/model/UserPermissionsModel.php";
require_once $root."/capstone/include/model/UserMediaModel.php";
require_once $root."/capstone/include/model/UserPlaylistModel.php";
require_once $root."/capstone/include/model/UserProfileModel.php";
require_once $root."/capstone/include/model/UserUploadModel.php";

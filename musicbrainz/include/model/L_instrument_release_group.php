...
/********************************************
 * L_instrument_release_group represents a table in musicbrainz 
 *
 * @author  megan
 * @version 190704
 ********************************************
 */
class L_instrument_release_group extends DBObject
{    
    public $id=0;
    public $link=0;
    public $entity0=0;
    ...
    /*****************************************************
     * Returns an HTTP parameter list for L_instrument_release_group object
     *
     * @return
     *****************************************************
     */
    ...
    /**************************************************************
     * Returns a JSON encoded representation of the L_instrument_release_group object
     *
     * @return JSON
     **************************************************************
     */
    ...
    /******************************************************
     * Construct a L_instrument_release_group from a JSONObject.
     *
     * @param json
     *        A JSONObject.
     ******************************************************
     */
    function L_instrument_release_group($jsonString='')
    {
        //--------------------------------------------------------------------

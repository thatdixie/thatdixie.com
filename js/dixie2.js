...
function playOnIphone(p, u, pc, jb)
{
    ...
    //--------------------------------------------------------
    URL='/capstone/api/play_next/index.php?username='+username+'&passcode='+passcode+'&jukeboxId='+jukeboxId;
...
function searchCatalog() {
    ...
    //------------------------------------------------------
    searchUrl ='/capstone/api/search_song/index.php?username='+username+
	                       '&passcode='+passcode+
	                       '&jukeboxId='+jukeboxId+
	                       '&searchKey='+searchKey;
...
function pickJukeboxSong(mediaId) {
    ...
    // Manufacture a URL that we send to REST API function
    //------------------------------------------------------
    queueUrl ='/capstone/api/add_queue/index.php?username='+username+
	                       '&passcode='+passcode+
	                       '&jukeboxId='+jukeboxId+
	                       '&mediaId='+mediaId;
...
function searchProfile() {
    ...
    // Manufacture a URL that we send to REST API function
    //------------------------------------------------------
    searchUrl ='/capstone/api/search_profile/index.php?username='+username+
	                          '&passcode='+passcode+
	                          '&searchKey='+searchKey;

...
function playOnIphone(p, u, pc, jb)
{
    ...
    //--------------------------------------------------------
    URL='http://thepeoplesjukebox.com/api/play_next/index.php?username='+username+'&passcode='+passcode+'&jukeboxId='+jukeboxId;
...
function searchCatalog() {
    ...
    //------------------------------------------------------
    searchUrl ='http://thepeoplesjukebox.com/api/search_song/index.php?username='+username+
	                       '&passcode='+passcode+
	                       '&jukeboxId='+jukeboxId+
	                       '&searchKey='+searchKey;
...
function pickJukeboxSong(mediaId) {
    ...
    // Manufacture a URL that we send to REST API function
    //------------------------------------------------------
    queueUrl ='http://thepeoplesjukebox.com/api/add_queue/index.php?username='+username+
	                       '&passcode='+passcode+
	                       '&jukeboxId='+jukeboxId+
	                       '&mediaId='+mediaId;
...
function searchProfile() {
    ...
    // Manufacture a URL that we send to REST API function
    //------------------------------------------------------
    searchUrl ='http://thepeoplesjukebox.com/api/search_profile/index.php?username='+username+
	                          '&passcode='+passcode+
	                          '&searchKey='+searchKey;
